...
beachfront_javascript_file="$root/plugins/beachfront/grails-app/assets/javascript/beachfront.js"
tlv_javascript_folder="$root/tlv/time_lapse/grails-app/assets/javascript/"
